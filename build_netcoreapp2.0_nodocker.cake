...
public void StageRelease(string runtimeIdentifier) 
{
    ...
    var cafeParentDirectory = buildDir + Directory("netcoreapp2.0");
    
    CopyDirectory(cafeParentDirectory + Directory(runtimeIdentifier + "-x64") + Directory("publish"), versionStagingDirectory);
    CopyDirectory(cafeUpdaterBuildDir + Directory("netcoreapp2.0") + Directory(runtimeIdentifier + "-x64") + Directory("publish"), updaterStagingDirectory);
}
...
var cafeWindowsPublishDirectory = buildDir + Directory("netcoreapp2.0/win10-x64/publish");
